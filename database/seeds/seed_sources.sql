...
FROM (VALUES
    ...
    ('Gestion',            'rss', '{"feed_url":"https://gestion.pe/arc/outboundfeeds/rss/?outputType=xml"}'::text,    'Peru', 'es', 9, false, true, 300),
    ('El Comercio',        'rss', '{"feed_url":"https://elcomercio.pe/arc/outboundfeeds/rss/?outputType=xml"}'::text, 'Peru', 'es', 9, false, true, 300),
    ('Andina',             'rss', '{"feed_url":"https://andina.pe/agencia/rss.aspx"}'::text,                  'Peru', 'es', 10, false, true, 300),
    ('Peru21',             'rss', '{"feed_url":"https://peru21.pe/arc/outboundfeeds/rss/?outputType=xml"}'::text,     'Peru', 'es', 7, false, true, 300),
    ('La Republica',       'rss', '{"feed_url":"https://larepublica.pe/arc/outboundfeeds/rss/?outputType=xml"}'::text,'Peru', 'es', 8, false, true, 300),
    ('Depor',              'rss', '{"feed_url":"https://depor.com/arc/outboundfeeds/rss/?outputType=xml"}'::text,     'Peru', 'es', 6, false, true, 300),
    ('El Bocon',           'rss', '{"feed_url":"https://elbocon.pe/arc/outboundfeeds/rss/?outputType=xml"}'::text,    'Peru', 'es', 5, false, true, 300),
    ('BBC Mundo',          'rss', '{"feed_url":"https://feeds.bbci.co.uk/mundo/rss.xml"}'::text,               'Internacional', 'es', 8, false, true, 300),
    ('Reuters',            'rss', '{"feed_url":"https://www.reuters.com/arc/outboundfeeds/newsletter-rss/"}'::text,   'Internacional', 'en', 8, false, true, 300),
